...
- `app/services/llm.py` — AsyncOpenAI + Groq, TOOLS (ChatCompletionToolParam), TOOL_MAP, chat() with tools_enabled
...
## Next Topics
15. **Evaluation** — NEXT (LLM-as-judge scoring, RAG answer test harness)
16. Observability
17. Auth & API Keys
18. Background jobs
19. Deployment
